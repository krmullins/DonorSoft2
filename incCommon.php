	...
	*/
	...
	function get_sql_fields($table_name) {
		$sql_fields = [
			...
			'Donations' => "`Donations`.`ID` as 'ID', if(`Donations`.`DonationDate`,date_format(`Donations`.`DonationDate`,'%m/%d/%Y'),'') as 'DonationDate', CONCAT('$', FORMAT(`Donations`.`Amount`, 2)) as 'Amount', `Donations`.`Description` as 'Description', IF(    CHAR_LENGTH(`Supporters1`.`LastName`) || CHAR_LENGTH(`Supporters1`.`MailingName`), CONCAT_WS('',   `Supporters1`.`LastName`, ', ', `Supporters1`.`MailingName`), '') as 'SupporterID', IF(    CHAR_LENGTH(`Campaigns1`.`CampaignName`), CONCAT_WS('',   `Campaigns1`.`CampaignName`), '') as 'CampaignID', `Donations`.`Paytype` as 'Paytype', `Donations`.`Matching` as 'Matching', `Donations`.`Anonymous` as 'Anonymous', `Donations`.`Acknowledged` as 'Acknowledged', `Donations`.`DonationYear` as 'DonationYear', `Donations`.`Notes` as 'Notes', `Donations`.`MemoryOf` as 'MemoryOf', `Donations`.`HonorOf` as 'HonorOf', IF(    CHAR_LENGTH(`Supporters1`.`MailingNameFull`), CONCAT_WS('',   `Supporters1`.`MailingNameFull`), '') as 'MailingName', IF(    CHAR_LENGTH(`Supporters1`.`Address1`), CONCAT_WS('',   `Supporters1`.`Address1`), '') as 'Address1', IF(    CHAR_LENGTH(`Supporters1`.`Address2`), CONCAT_WS('',   `Supporters1`.`Address2`), '') as 'Address2', IF(    CHAR_LENGTH(`Supporters1`.`City`), CONCAT_WS('',   `Supporters1`.`City`), '') as 'City', IF(    CHAR_LENGTH(`Supporters1`.`State`), CONCAT_WS('',   `Supporters1`.`State`), '') as 'State', IF(    CHAR_LENGTH(`Supporters1`.`Zip`), CONCAT_WS('',   `Supporters1`.`Zip`), '') as 'Zip', IF(    CHAR_LENGTH(`Supporters1`.`Country`), CONCAT_WS('',   `Supporters1`.`Country`), '') as 'Country'",
		...
		$pcConfig = [
			...
			'Donations' => [
				'SupporterID' => [
					...
					'forced-where' => '',
					'display-fields' => [1 => 'Donation Date', 2 => 'Amount', 3 => 'Description', 4 => 'Supporter', 5 => 'Campaign', 6 => 'Payment Type', 7 => 'Matching', 8 => 'Anonymous', 9 => 'Acknowledged', 10 => 'Donation Year', 11 => 'Notes'],
					'display-field-names' => [1 => 'DonationDate', 2 => 'Amount', 3 => 'Description', 4 => 'SupporterID', 5 => 'CampaignID', 6 => 'Paytype', 7 => 'Matching', 8 => 'Anonymous', 9 => 'Acknowledged', 10 => 'DonationYear', 11 => 'Notes'],
					'sortable-fields' => [0 => '`Donations`.`ID`', 1 => '`Donations`.`DonationDate`', 2 => '`Donations`.`Amount`', 3 => 4, 4 => 5, 5 => '`Campaigns1`.`CampaignName`', 6 => 7, 7 => '`Donations`.`Matching`', 8 => '`Donations`.`Anonymous`', 9 => '`Donations`.`Acknowledged`', 10 => 11, 11 => 12, 12 => 13, 13 => 14, 14 => '`Supporters1`.`MailingNameFull`', 15 => '`Supporters1`.`Address1`', 16 => '`Supporters1`.`Address2`', 17 => '`Supporters1`.`City`', 18 => '`Supporters1`.`State`', 19 => '`Supporters1`.`Zip`', 20 => '`Supporters1`.`Country`'],
					'records-per-page' => 10,
