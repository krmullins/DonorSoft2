	...
	$lookups = [
		...
		'Donations' => [
			...
			'Address1' => [
				'parent_table' => 'Supporters',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Supporters`.`Address1`',
				'parent_from' => '`Supporters` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'Address2' => [
				'parent_table' => 'Supporters',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Supporters`.`Address2`',
				'parent_from' => '`Supporters` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'City' => [
				'parent_table' => 'Supporters',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Supporters`.`City`',
				'parent_from' => '`Supporters` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'State' => [
				'parent_table' => 'Supporters',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Supporters`.`State`',
				'parent_from' => '`Supporters` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
			...
			'Country' => [
				'parent_table' => 'Supporters',
				'parent_pk_field' => 'ID',
				'parent_caption' => '`Supporters`.`Country`',
				'parent_from' => '`Supporters` ',
				'filterers' => [],
				'custom_query' => '',
				'inherit_permissions' => false,
